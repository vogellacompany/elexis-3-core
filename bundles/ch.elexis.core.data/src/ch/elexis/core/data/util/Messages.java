...
public class Messages {
	...
	public static String DefaultContentProvider_noData = ch.elexis.core.l10n.Messages.DefaultContentProvider_noData;
	...
	public static String ImporterPage_importError = ch.elexis.core.l10n.Messages.ImporterPage_importError;
	...
	public static String LabeledInputField_blue = ch.elexis.core.l10n.Messages.LabeledInputField_blue;
	...
	public static String NoDataAvailable = ch.elexis.core.l10n.Messages.NoDataAvailable;
	...
	public static String SWTHelper_blue = ch.elexis.core.l10n.Messages.SWTHelper_blue;
	...
	public static String TemplateDrucker_couldntPrint = ch.elexis.core.l10n.Messages.TemplateDrucker_couldntPrint;
	public static String TemplateDrucker_docname = ch.elexis.core.l10n.Messages.TemplateDrucker_docname;
	public static String TemplateDrucker_errorPrinting = ch.elexis.core.l10n.Messages.TemplateDrucker_errorPrinting;
	public static String TemplateDrucker_printing = ch.elexis.core.l10n.Messages.TemplateDrucker_printing;
	public static String TreeContentProvider_loadData = ch.elexis.core.l10n.Messages.TreeContentProvider_loadData;
